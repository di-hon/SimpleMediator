...
public sealed class PerformanceTests
{
    ...
    public async Task Send_FirstCall_CompletesInReasonableTime()
    {
        ...
        services.AddDispatcher(typeof(PerformanceTests).Assembly);
    ...
    public async Task Send_CompareToDirectCall_HasMinimalOverhead()
    {
        ...
        overhead.Should().BeLessThan(10.0, "Dispatcher should have less than 10x overhead compared to direct calls");
    }
}